...
var SparqlParser = require('sparqljs').Parser,
    ...
    TripleGraphIterator = require('./TripleGraphIterator'),
...
function SparqlGroupIterator(source, group, options) {
  ...
  switch (group.type) {
  case 'bgp':
    // TODO: does the 'source' parameter have any significance?
    console.error('bgp found');
    return new TripleGraphIterator(group.triples, options);
  case 'group':
