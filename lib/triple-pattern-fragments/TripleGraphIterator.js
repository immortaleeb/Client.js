...
TripleGraphIterator.prototype._executeAllCheapRequests = function (callback) {
  ...
  // DEBUG
  cheapestRequest && console.error(cheapestRequest.type + ' (cost: ' + cheapestRequest.cost + ')', cheapestRequest.triple.subject, cheapestRequest.triple.predicate, cheapestRequest.triple.object);
